...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,   KC_MUTE,    KC_MPLY,  KC_N   , KC_M   , KC_COMM, KC_DOT , KC_QUOT, KC_RCTL,
          KC_ESC , MO(2)  , KC_LGUI, LT(1,KC_ENT), KC_LALT,                    RALT_T(KC_BSPC), LT(1,KC_SPC),  KC_RGUI , MO(2)   , KC_ESC),

	[1] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                      _______, KC_7   , KC_8   , KC_9   , KC_SLSH, KC_COMM ,
        _______, _______, _______, KC_LBRC, KC_RBRC, _______,                      _______, KC_4   , KC_5   , KC_6   , LSFT(KC_8), KC_EQL,
        _______, _______, _______, KC_LPRN, KC_RPRN, _______,                      KC_0   , KC_1   , KC_2   , KC_3   ,  KC_MINS , LSFT(KC_EQL) ,
        _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______,    _______, KC_HOME, LALT(KC_LEFT), KC_UP, LALT(KC_RIGHT), KC_END, KC_PSCR,
