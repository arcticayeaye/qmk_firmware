...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                      _______, KC_7   , KC_8   , KC_9   , LSFT(KC_EQL) , KC_MINS ,
        _______, _______, _______, KC_LBRC, KC_RBRC, _______,                      _______, KC_4   , KC_5   , KC_6   , LSFT(KC_8), KC_SLSH,
        _______, _______, _______, KC_LPRN, KC_RPRN, _______,                      KC_0   , KC_1   , KC_2   , KC_3   , KC_COMM, KC_EQL,
        _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______,    _______, KC_HOME, LALT(KC_LEFT), KC_UP, LALT(KC_RIGHT), KC_END, KC_PSCR,
             _______, _______, _______, _______, _______,                             KC_DEL , _______, KC_LEFT, KC_DOWN, KC_RGHT),
	[2] = LAYOUT(
